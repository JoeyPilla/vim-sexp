...
let s:sexp_mappings = {
    ...
    \ 'sexp_indent':                    '==',
    \ 'sexp_indent_top':                '=-',
    \ 'sexp_round_head_wrap_list':      '<LocalLeader>xi',
    \ 'sexp_round_tail_wrap_list':      '<LocalLeader>xI',
    \ 'sexp_square_head_wrap_list':     '<LocalLeader>x[',
    \ 'sexp_square_tail_wrap_list':     '<LocalLeader>x]',
    \ 'sexp_curly_head_wrap_list':      '<LocalLeader>x{',
    \ 'sexp_curly_tail_wrap_list':      '<LocalLeader>x}',
    \ 'sexp_round_head_wrap_element':   '<LocalLeader>xw',
    \ 'sexp_round_tail_wrap_element':   '<LocalLeader>xW',
    \ 'sexp_square_head_wrap_element':  '<LocalLeader>xe[',
    \ 'sexp_square_tail_wrap_element':  '<LocalLeader>xe]',
    \ 'sexp_curly_head_wrap_element':   '<LocalLeader>xe{',
    \ 'sexp_curly_tail_wrap_element':   '<LocalLeader>xe}',
    \ 'sexp_insert_at_list_head':       '<LocalLeader>xh',
    \ 'sexp_insert_at_list_tail':       '<LocalLeader>xl',
    \ 'sexp_splice_list':               '<LocalLeader>x@',
    \ 'sexp_convolute':                 '<LocalLeader>x?',
    \ 'sexp_raise_list':                '<LocalLeader>xo',
    \ 'sexp_raise_element':             '<LocalLeader>xO',
    \ 'sexp_swap_list_backward':        '<LocalLeader>xB',
    \ 'sexp_swap_list_forward':         '<LocalLeader>xF',
    \ 'sexp_swap_element_backward':     '<LocalLeader>xb',
    \ 'sexp_swap_element_forward':      '<LocalLeader>xf',
    \ 'sexp_emit_head_element':         '<LocalLeader>xeh',
    \ 'sexp_emit_tail_element':         '<LocalLeader>xet',
    \ 'sexp_capture_prev_element':      '<LocalLeader>xcp',
    \ 'sexp_capture_next_element':      '<LocalLeader>xcn',
    \ }
